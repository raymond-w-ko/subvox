...
local light = {
  ...
  { "ColorColumn", { "guibg=NvimLightGrey4", ctermbg(CTERM.white) } },
  ...
  { "DiffAdd", { "guifg=NvimDarkGrey1", "guibg=NvimLightGreen", ctermfg(CTERM.dark_green), ctermbg(CTERM.white) } },
  { "DiffChange", { "guifg=NvimDarkGrey1", "guibg=NvimLightGrey4", ctermfg(CTERM.dark_grey) } },
  { "DiffDelete", { "guifg=NvimDarkRed", "gui=bold", ctermfg(CTERM.dark_red), ctermbg(CTERM.white), "cterm=bold" } },
  { "DiffText", { "guifg=NvimDarkGrey1", "guibg=NvimLightCyan", ctermfg(CTERM.dark_cyan), ctermbg(CTERM.white) } },
...
local dark = {
  ...
  { "ColorColumn", { "guibg=NvimDarkGrey4", ctermbg(CTERM.black) } },
  ...
  { "DiffAdd", { "guifg=NvimLightGrey1", "guibg=NvimDarkGreen", ctermfg(CTERM.light_green), ctermbg(CTERM.black) } },
  { "DiffChange", { "guifg=NvimLightGrey1", "guibg=NvimDarkGrey4", ctermfg(CTERM.dark_grey) } },
  { "DiffDelete", { "guifg=NvimLightRed", "gui=bold", ctermfg(CTERM.light_red), ctermbg(CTERM.black) } },
  { "DiffText", { "guifg=NvimLightGrey1", "guibg=NvimDarkCyan", ctermfg(CTERM.dark_cyan), ctermbg(CTERM.black) } },
  ...
  { "Visual", { "guibg=NvimDarkGrey4", ctermfg(CTERM.dark_grey), ctermbg(CTERM.black) } },
  ...
  { "PreProc", { "guifg=NvimLightGrey2", ctermfg(CTERM.light_magenta) } },
  { "Type", { "guifg=NvimLightGrey2", ctermfg(CTERM.light_grey) } },
  { "Delimiter", { "guifg=NvimLightGrey2", ctermfg(CTERM.light_grey) } },
  { "Comment", { "guifg=NvimLightGrey4", ctermfg(CTERM.dark_magenta) } },
  { "String", { "guifg=NvimLightGreen", ctermfg(CTERM.dark_green) } },
  { "Identifier", { "guifg=NvimLightBlue", ctermfg(CTERM.light_blue) } },
  { "Function", { "guifg=NvimLightCyan", ctermfg(CTERM.dark_red) } },
  { "Statement", { "guifg=NvimLightGrey2", "gui=bold", ctermfg(CTERM.dark_blue), "cterm=bold" } },
