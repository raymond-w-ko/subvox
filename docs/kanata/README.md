...
- [Current layout versus Ben Vallack](layout-differences.md) — matching hold positions and remaining differences after moving modifiers to the home row and layers to the bottom row.
...
After editing `kanata/gen.clj`, regenerate both configurations and their images from the repository root:
